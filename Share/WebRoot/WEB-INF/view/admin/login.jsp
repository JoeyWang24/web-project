...
<div class="container">
    <form class="form-signin" role="form" method="post" action="${path }/admin/login.do">
        <h1 class="form-signin-logo"></h1>
        <div class="form-signin-title">
            <h1 class="form-signin-heading">Share</h1>
            <h3 class="form-signin-subtitle">后台管理登陆&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h3>
        </div>
        ...
        <div class="input-group">
            ...
            <span type="captchaholder" class="input-group-addon">
            	<img height="30px" src="${path }/admin/getCode.do" style="cursor:pointer;" id="codeImg"
                     title="点击切换验证码">
            </span>
        </div>
...
<script>
    $(function () {
        ...
        $("#codeImg").click(function () {
            var baseSrc = "${path}/admin/getCode.do";
